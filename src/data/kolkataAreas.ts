...
export const KOLKATA_AREAS: KolkataArea[] = [
  ...
  { name: 'Salt Lake Sector V (IT Hub)', pincode: '700091', zone: 'East', hub: 'Salt Lake Sector V Hub', deliveryMinutes: 35, serviceable: true, lat: 22.5735, lng: 88.4331, exactStreet: 'College More, EP Block, Sector V' },
